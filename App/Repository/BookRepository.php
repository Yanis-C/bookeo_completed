...
class BookRepository extends Repository
{
    ...
    {
        //@todo_done commencer par une requête simple puis gérer la pagination
        $booksArray = [];
        ...
        //@todo_done faire une boucle sur le tableau de livre pour hydrater et stocker les objets livres avec Book::createAndHydrate
        if (!empty($books)) {
